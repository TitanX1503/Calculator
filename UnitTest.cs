...
namespace Calculator
{
    ...
    class UnitTests
    {
        ...
        //     Assert.That(calculator.GetScreenMessage(), Is.EqualTo("1-"));
        //     calculator.PressNumber(2);
        //     Assert.That(calculator.GetScreenMessage(), Is.EqualTo("1-2"));
        //     calculator.CalculateResult();
        //     Assert.That(calculator.GetScreenMessage(), Is.EqualTo("-1"));
        ...
        //     Assert.That(calculator.GetScreenMessage(), Is.EqualTo("2"));
        //     calculator.PressNumber(1);
        //     Assert.That(calculator.GetScreenMessage(), Is.EqualTo("21"));
        //     calculator.Substract();
        //     Assert.That(calculator.GetScreenMessage(), Is.EqualTo("21-"));
        //     calculator.PressNumber(1);
        //     Assert.That(calculator.GetScreenMessage(), Is.EqualTo("21-1"));
        //     calculator.PressNumber(2);
        //     Assert.That(calculator.GetScreenMessage(), Is.EqualTo("21-12"));
        //     calculator.CalculateResult();
        //     Assert.That(calculator.GetScreenMessage(), Is.EqualTo("9"));
        ...
        public void CalculatorSubTest()
        {
            ...
            // Input incompleto o en desorden
            ...
            Assert.That(calculator.GetScreenMessage(), Is.EqualTo("0-"));
            calculator.PressNumber(5);
            Assert.That(calculator.GetScreenMessage(), Is.EqualTo("0-5"));
            ...
            calculator.PressNumber(4);
            Assert.That(calculator.GetScreenMessage(), Is.EqualTo("0-1928398174"));
            calculator.CalculateResult();
            Assert.That(calculator.GetScreenMessage(), Is.EqualTo("-1928398174"));

            // 0-1928398174-9823367549823
            calculator.PressNumber(0);
            Assert.That(calculator.GetScreenMessage(), Is.EqualTo("0"));
            calculator.Substract();
            Assert.That(calculator.GetScreenMessage(), Is.EqualTo("0-"));
            ...
            calculator.PressNumber(2);
            calculator.PressNumber(3);
            Assert.That(calculator.GetScreenMessage(), Is.EqualTo("0-1928398174-9823367549823"));

            calculator.CalculateResult();
            Assert.That(calculator.GetScreenMessage(), Is.EqualTo("-9825295947997"));
